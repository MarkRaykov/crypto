...
public class Main {
    public static void main(String[] args) {
        ...
        // Дополнительная демонстрация с конкретным примером
        System.out.println("\nДемонстрация работы на примере");
        String example = "АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ абвгдеёжзийклмнопрстуфхцчшщъыьэюя";
        System.out.println("Исходный текст: " + example);

        String encryptedExample = PR1.encrypt(example);
        System.out.println("Зашифрованный:  " + encryptedExample);

        String decryptedExample = PR1.decrypt(encryptedExample);
        System.out.println("Расшифрованный: " + decryptedExample);
    }
}
